...
echo "${CYAN_TEXT}${BOLD_TEXT}      SUBSCRIBE SakshamXTech -  EXECUTION STARTED...              ${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}==================================================================${RESET_FORMAT}"
echo
echo "${RED_TEXT}${BOLD_TEXT}      https://www.youtube.com/@sakshamxtech ${RESET_FORMAT}"
echo
...
echo
echo "${RED_TEXT}${BOLD_TEXT}SakshamXTech - https://www.youtube.com/@sakshamxtech${RESET_FORMAT}"
echo
