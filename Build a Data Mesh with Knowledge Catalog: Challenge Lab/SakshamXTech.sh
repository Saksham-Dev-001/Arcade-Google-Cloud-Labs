...
echo "${ORANGE_TEXT}${BOLD_TEXT}                 Subscribe SakshamXTech                           ${RESET_FORMAT}"
echo "${ORANGE_TEXT}${BOLD_TEXT}==================================================================${RESET_FORMAT}"
echo
...
echo "${ORANGE_TEXT}${BOLD_TEXT}Subscribe to SakshamXTech{RESET_FORMAT}"
echo "${ORANGE_TEXT}${BOLD_TEXT}${UNDERLINE_TEXT}https://www.youtube.com/@sakshamxtech${RESET_FORMAT}"