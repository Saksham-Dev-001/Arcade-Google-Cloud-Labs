...
curl -LO https://raw.githubusercontent.com/Saksham-Dev-001/Arcade-Google-Cloud-Labs/refs/heads/main/Create%20and%20Manage%20Cloud%20Spanner%20Instances%3A%20Challenge%20Lab/Customer_List_500.csv
...
touch sakshamxtech
gsutil cp sakshamxtech gs://$DEVSHELL_PROJECT_ID/tmp/sakshamxtech
...
gcloud dataflow jobs run sakshamxtech \
