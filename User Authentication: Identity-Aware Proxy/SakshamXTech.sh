...
echo
echo "${MAGENTA_TEXT}${BOLD_TEXT}Subscribe to SakshamXTech for more! 👇${RESET_FORMAT}"
echo "${PINK_TEXT}${BOLD_TEXT}${UNDERLINE_TEXT}https://www.youtube.com/@sakshamxtech${RESET_FORMAT}"
echo